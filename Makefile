...
am_myprogram_OBJECTS = main.$(OBJEXT) FuncClass.$(OBJEXT) \
	HTTP_Server.$(OBJEXT)
myprogram_OBJECTS = $(am_myprogram_OBJECTS)
myprogram_LDADD = $(LDADD)
myprogram_LINK = $(CXXLD) $(AM_CXXFLAGS) $(CXXFLAGS) \
	$(myprogram_LDFLAGS) $(LDFLAGS) -o $@
am_test_OBJECTS = test.$(OBJEXT) FuncClass.$(OBJEXT)
...
ACLOCAL = ${SHELL} '/home/vboxuser/KPI_DevOPS/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} '/home/vboxuser/KPI_DevOPS/missing' autoconf
AUTOHEADER = ${SHELL} '/home/vboxuser/KPI_DevOPS/missing' autoheader
AUTOMAKE = ${SHELL} '/home/vboxuser/KPI_DevOPS/missing' automake-1.16
AWK = mawk
CC = gcc
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} '/home/vboxuser/KPI_DevOPS/missing' makeinfo
...
abs_top_srcdir = /home/vboxuser/KPI_DevOPS
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/vboxuser/KPI_DevOPS/install-sh
...
myprogram_SOURCES = main.cpp FuncClass.cpp FuncClass.h HTTP_Server.cpp
myprogram_LDFLAGS = -static
test_SOURCES = test.cpp FuncClass.cpp
...
myprogram$(EXEEXT): $(myprogram_OBJECTS) $(myprogram_DEPENDENCIES) $(EXTRA_myprogram_DEPENDENCIES) 
	...
	$(AM_V_CXXLD)$(myprogram_LINK) $(myprogram_OBJECTS) $(myprogram_LDADD) $(LIBS)
